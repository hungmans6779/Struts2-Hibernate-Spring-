package com.spring.client.bean.beanFactoryPostProcessor;

import org.springframework.context.ApplicationContext;
import org.springframework.context.support.FileSystemXmlApplicationContext;

import com.spring.bean.beanFactoryPostProcessor.Life;
...
public class Client_ApplicationContext {
	...
	public static void main(String[] args) {
		...
		ApplicationContext ac = new FileSystemXmlApplicationContext("src\\spring_beanFactoryPostProcessor.xml");
