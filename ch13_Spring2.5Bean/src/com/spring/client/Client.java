...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out.println(person.sayGoodbye("kevin-1"));

		System.out.println("\n");
		person = (Person) factory2.getBean("american");
		System.out.println(person.sayHello("kevin"));
		System.out.println(person.sayGoodbye("kevin-2"));

		System.out.println("\n");
		person = (Person) factory3.getBean("chinese");
		System.out.println(person.sayHello("kevin"));
		System.out.println(person.sayGoodbye("kevin-3"));

		System.out.println("\n");
		person = (Person) factory4.getBean("american");
		System.out.println(person.sayHello("kevin"));
		System.out.println(person.sayGoodbye("kevin-4"));

		
		System.out.println("\n");
		person = (Person) factory5.getBean("chinese");
		System.out.println(person.sayHello("kevin"));
		System.out.println(person.sayGoodbye("kevin-5"));
		
		
		System.out.println("\n");
		person = (Person) factory6.getBean("american");
		System.out.println(person.sayHello("kevin"));
		System.out.println(person.sayGoodbye("kevin-6"));
