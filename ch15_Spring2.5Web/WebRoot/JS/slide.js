...
if (xsPlayBtn != 0) {
		document.write("<a id=\"slideplay\" title=\"섹⑾\" href=\""+ xsImgLinks[0] +"\">섹⑾<\/a>")
}
	
	if (xsImgTexts.length != 0) {
		document.write("<a id=\"slideprev\" title=\"쨁�@큈\" href=\"#\" onclick=\"rewind();return false\">&lt;&lt;<\/a><a id=\"slidenext\" title=\"짾�@큈\" href=\"#\" onclick=\"forward();return false\" style=\"text-align: center; text-decoration: none;\">&gt;&gt;<\/a><p id=\"slidetext\"><a href=\""+ xsImgLinks[0] +"\" target=\"_blank\">"+ xsImgTexts[0] +"<\/a><\/p>")
	}
