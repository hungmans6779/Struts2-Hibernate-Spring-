...
public class Client01 {
	...
	public static void main(String[] args) {
      ...
      System.out.println("\n");
      bean = (Person01)factory1.getBean("chinese01");
	  bean.useAxe();
	  
	  System.out.println("\n");
	  bean = (Person01)factory2.getBean("chinese01");
	  bean.useAxe();
	  
      System.out.println("\n");
      bean = (Person01)factory3.getBean("chinese01");
	  bean.useAxe();
	  
	  System.out.println("\n");
	  bean = (Person01)factory4.getBean("chinese01");
	  bean.useAxe();
	  
      System.out.println("\n");
      bean = (Person01)factory5.getBean("chinese01");
	  bean.useAxe();
	  
	  System.out.println("\n");
	  bean = (Person01)factory6.getBean("chinese01");
	  bean.useAxe();
